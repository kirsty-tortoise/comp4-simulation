...
class CoinOnRoundabout(SimulationScreen):
    ...
    def __init__(self):
        ...
        coinForceDiagram = ForceDiagram("Force Diagram", "CoinDiagram.png")
...
class CarOnRacetrack(SimulationScreen):
    ...
    def __init__(self):
        ...
        flyingOffUnresolved = ForceDiagram("Flying Off", "CarDiagramUpSlope.png")
        flyingOffResolved = ForceDiagram("Resolved", "CarDiagramResolvedUpSlope.png")
        fallingInUnresolved = ForceDiagram("Falling In", "CarDiagramDownSlope.png")
        fallingInResolved = ForceDiagram("Resolved", "CarDiagramResolvedDownSlope.png")
...
class VerticalRotation(SimulationScreen):
    ...
    def __init__(self):
        ...
        generalForceDiagram = ForceDiagram("Force Diagram", "VerticalCirclesForces.png")
